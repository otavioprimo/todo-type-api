...
class EnviarEmail {
    static cadastro(email, name, token) {
        mail_1.default.to = email;
        mail_1.default.subject = "Confirmar Email";
        mail_1.default.message = `
        <html>
            <head>
    ...
    static recuperarSenha(email, name, token) {
        mail_1.default.to = email;
    ...
    static pedidoAmigo(email, nome_usuario, nome_amigo, foto, mensagem) {
        mail_1.default.to = email;
        mail_1.default.subject = "Recuperação de Senha";
        mail_1.default.message = `
        <html>
